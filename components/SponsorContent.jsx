...
const sponsor = () => {
      return (
            <div className={styles.container}>
                  ...
                  <div className={styles.gfg}> <img src="/images/paypal.png" /> <p1>paypal.com/paypalme/labrats</p1></div>
                  <div className={styles.gfg1}> <img src="/images/bdo.png" /> <p1>10215659345413</p1></div>
                  <div className={styles.gfg2}> <img src="/images/gcash.png" /> <p1>Send to 09958926020 Lyn S.</p1></div>
